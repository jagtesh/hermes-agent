...
- **Switch sources from the Sessions sidebar.** Small registries show direct source glyphs; larger fleets use one compact menu. The adjacent profile rail then shows the agents on that source and remembers the last profile used there.
